...
$wp_cron_key = "93a49092db5559cb37aaf13e2b02cce3e5c2c1aa";
...
register_activation_hook(__FILE__, 'wpcron_build_hit_file');

/**
 * Builds the hit file and registers it
 */
function wpcron_build_hit_file(){
	
	$fp = fopen("hit.php", "a+");
	fwrite($fp, "<?php
	echo \"hit file created!\";	
	?>");
	fclose($fp);
}
